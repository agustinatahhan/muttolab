      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section>
            ...
            >
              {course.isBundle
                ? "¿Por qué hacer los 3 talleres juntos?"
                : "Sobre el taller"}
            </h2>
        ...
        <aside>
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 sticky top-24 space-y-5">
            ...
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSdVaa3fjZ0g5RNaRzFhiJEkbj3U5_gfcKuXk3OiPxKTNN1vTQ/viewform"
              target="_blank"
              rel="noopener noreferrer"
              className="btn-primary w-full justify-center text-sm pt-4"
            >
